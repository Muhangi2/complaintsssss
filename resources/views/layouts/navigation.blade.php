                    ...
                    <div class="form-group mt-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleSelect">
                              <option name="category_name" >Marks</option>
                              <option  name="category_name" >Registration</option>
                              <option  name="category_name" >Tution</option>
                            </select>
                          </div>
                    </div>
                    <div class="form-group mt-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="exampleSelect">
                              <option name="course_category">BSSE </option>
                              <option name="course_category">BIST</option>
                              <option name="course_category">CS</option>
                            </select>
                          </div>
                      </div>
                    <div class="form-group mt-3">
